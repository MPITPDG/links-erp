...
@Component({
    ...
    templateUrl: './rcbl-anyoneClnt-allbrnch.component.html',
    styles: []
  })
  export class ReceivableAnyOneClientAllBranch implements OnInit {
  
    AccountList:any = [];
    Client:string;
    ClientName:string;
    Status:string="All"
    Header:string="RECEIVABLE - ANY ONE CLIENT ALL BRANCH";
