...
@Component({
    selector: 'app-agentjobprofit',
    templateUrl: './agent_jobprofit.component.html',
    styles: []
})
export class AgentJobprofitComponent implements OnInit {
    ...
    PageName: string = "Agent Job Profit "
    ...
    ngOnInit() {
      ...
      console.log('testing agent job profit')
    }
      FromDateChanged(ev){
    ...
    FillAccount() {
        ...
        this._dataService.getData("Accounts/ACC_SUPPLIER_AS_AGENT", jsonItem)
            .subscribe((data: any) => {
    ...
    calculate(){
        ...
        if (this.searchtype == "DATEWISE") {
            ...
            this.fromval=this.FromDate.formatted;
            this.toval=this.ToDate.formatted;
          }
          else {
            this.mode=""
            this.searchtype="";
