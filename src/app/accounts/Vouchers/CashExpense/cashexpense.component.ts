...
@Component({
  ...
  templateUrl: './cashexpense.component.html',
  styles: []
})
  ...
  //  console.log(jsonmaster)
    this._dataService.getData("Accounts/ACC_CASHBOOK_BRBPCRCPCE_PAGELOAD", jsonmaster)
      .subscribe((data: any) => {  
        ...
        this.employyetable = data.Table4
...
getCopyOfOptions(): IMyDpOptions {
  ...
  Addchildrcrd() {
    //  console.log(this.AccountName)
     ...
     this.loaderService.display(true);
     this.EmployeeName = this.employyetable.filter((code: any) => code.ACCTCODE == this.employee)[0].ACCTNAME;
      ...
      this._dataService.Common("Accounts/ACC_BRBPCRCPCE_IU", jsonmaster)
        .subscribe((data: any) => {   
          ...
          if (data.Table[0].STATUS == "100") {
            ...
            window.open('./#/popup/Account-CashBook-BankReceipt-print/' + "CE" + '/' + data.Table[0].ENTRYNO + '/' , "CashBook BankReceipt Print", toolbar);
            this.RestMain()
