...
@Component({
    templateUrl: 'journalvoucher-IUOld.component.html'
})
export class JournalVoucherOEComponent implements OnInit {
    ...
    Header: string="JOURNAL VOUCHER UPDATE OLD ENTRY";
    chkrules:string="N";
    ...
    public disablevoucherno:boolean=false;
    OldActualAmt:any;
    OldTotDebit:any;
    OldTotCredit:any;
    NEWNETTOTAMT:any;
...
ngOnInit() { 
    ...
    ShowoldData() {
        ...
        .subscribe((data: any) => { 
        this.VoucherNo  = data.Table2[0].JVCODE    ;
        this.VoucherDate=(data.Table2[0].JV_DATE != "") ? (data.Table2[0].JV_DATE) : "";
        ...
        this.disablevoucherno=true;
        this.TotalDebit=data.Table3[0].TOTDEBIT;
        this.TotalCredit=data.Table3[0].TOTCREDIT;
        this.OldActualAmt=data.Table3[0].NETTOTAL;
        this.OldTotCredit=data.Table3[0].TOTCREDIT;
        this.OldTotDebit=data.Table3[0].TOTDEBIT;
        })  
        }  
    }  
   
    Validate_JV_OldEntryNo(){
...
Add_Main()  {
    ...
    if(clientcodeval=='Y')   {
     ...
     const jsonchild= {ID:this.ID,ENTRYNO:this.VoucherNo,CLIENT:this.AccountName.split("|")[0],
