...
export class StaffPurchaseComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        // this._dataService.getData("Accounts/Fill_Accounts_Item",jsonparam)
        // .subscribe((data: any) => {
    ...
    Addchildrcrd()
    {
        ...
        //  if (isNumeric(this.Amount) == false) {
        //     return false;
        // }
        // if (isNumeric(this.Deduction) == false) {
        //     return false;
        // }
    ...
    if(this.PurchaseDone=="1")
    {
        ...
        return false;
            ...
            const jsonmaster = {
                ...
                ENTRYDT:this.PurchaseDate.formatted ,
                STATUS:this.STATUS,
                SUP_CODE:this.staff,
                SUP_NAME:"",
                SUP_INVNO:"",
             ...
             if(this.PurchaseNo==" ")
             {
             this._dataService.Common("Accounts/ACC_PURCHASE_INSERT", jsonmaster)
             .subscribe((data: any) => {
                 if (data.Table1[0].STATUS.split("#")[0] == "100") {
             ...
             {
                 this._dataService.Common("Accounts/ACC_PURCHASE_UPDATE", jsonmaster)
    ...
    GetActName(Acctcode)
    {
      ...
      this.codelistActt = this.AccountNameList.filter((code: any) => code.ACCTCODENAME === Acctcode);
        ...
        codeacct=this.codelistActt[0].ACCTCODE;
        this.ItemList = this.Allitemlist.filter((code: any) => code.ACCTCODENAME === Acctcode);
       ...
       editpopulate()
            {
        const jsonview = { EntryNo  : this.PurchaseNo,
