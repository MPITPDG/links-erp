...
@Component({
    selector: 'app-print-document-annexure-page-four',
    templateUrl: 'annexure-page-four-print.component.html'
})
export class AnnexurePageFourPrintComponent implements OnInit {
