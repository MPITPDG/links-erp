...
@Component({
    ...
    templateUrl: 'exp_fs_multicontainer_iu.component.html'
})
export class FSmulticontainerIU implements OnInit {
    Add:string="Add";
    vslrotation: any = "";
    vslport: any = "";
    vsldet: any = "";
    ...
    noofcontainers;
    public disable_grnerate_btn :boolean=false;
    public disable_noofcontainer :boolean=false;
    public disable_destport :boolean=false;
    public disable_contstatus :boolean=false;
    public disable_contsize :boolean=false;
    public disable_contsize1 :boolean=false;
    public disable_movetype :boolean=false;
    ...
    GenerateContainer(){
        ...
        .subscribe((data: any) => {
            ...
            if (data.Table[0].STATUS == "100") {
                this._toasterService.toast('info', 'Success', 'Containers added successfully');
