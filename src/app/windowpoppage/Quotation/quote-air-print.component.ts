...
@Component({
  ...
  templateUrl: './quote-air-print.component.html',
  styleUrls: ['./quote-print.component.css'] // or .scss
})
export class QuoteAirPrintComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    getDataforPrint()
    {
        ...
        .subscribe((data: any) => {
            ...
            this.chblwt=data.Table[0].CHWEIGHT;
