...
export class SeaSearchComponent implements OnInit {
    ...
    searchHeaderText: string = 'List of Sea';
    Mode: string = 'Sea';
    Type: string = 'CODE';
    ImportCode: any = '';
            ...
            .subscribe((data: any) => {
               ...
               // console.log(data);
                if (data.Table.length == 0) {
                    ...
                    this._router.navigate(["./import/sea/update-data/", data.Table[0].pk_ImpoterId]);
                }
                else if (data.Table.length > 1) {
